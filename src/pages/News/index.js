...
let news = [
    <TextBox news={true} title={<h3>Fall / Winter Must Read List for Beginner Programmers</h3>}
    ...
    <TextBox news={true} title={<h3>Our Head of HR speaks about our challenges during the pandemic</h3>}
    ...
    <TextBox news={true} title={<h3>Facilization Partners With Creatio (formerly bpm’online)</h3>}
    ...
    />,
    <TextBox news={true} title={<h3>Facilization organizes staff retreat in Struga, Macedonia!</h3>}
...
function News() {
    return (
        ...
        <PageWrapper children={
            <>
                <TextBox title={<h2>Fall/Winter Must Read List for Beginner Programmers</h2>} />
